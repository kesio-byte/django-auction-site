<<<<<<< HEAD
# Generated by Django 4.2.11 on 2026-03-16 12:39
=======
# Generated by Django 4.2.11 on 2026-03-19 19:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=64, validators=[django.core.validators.MinLengthValidator(4, 'Title must be at least 4 characters.'), auctions.models.validate_contains_letter])),
                ('description', models.TextField(validators=[django.core.validators.MinLengthValidator(10, 'Description must be at least 10 characters.'), django.core.validators.MaxLengthValidator(1000, 'Description cannot exceed 1000 characters.')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.TextField(validators=[django.core.validators.MinLengthValidator(2, 'Comment must be at least 2 characters.'), django.core.validators.MaxLengthValidator(500, 'Comment cannot exceed 500 characters.')])),
